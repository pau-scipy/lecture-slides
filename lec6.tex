...
%mean max min of matrix or each row, column

% transpose

% plot distributions in ascii
...
% sort matrix on a particular column
% print(Z[Z[:,1].argsort()])

% bincount and ascii plots

% heights of trees in forest 
